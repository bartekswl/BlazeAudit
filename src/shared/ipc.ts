...
export const IpcChannels = {
  ...
  updateGetRollbackInfo: 'update:get-rollback-info',
  ...
  databaseImportClientsCsv: 'database:import-clients-csv',
  databaseGetDataDir: 'database:get-data-dir',
  databaseOpenDataFolder: 'database:open-data-folder',
  databaseExportBackup: 'database:export-backup',
  databaseInspectBackup: 'database:inspect-backup',
  databaseApplyBackup: 'database:apply-backup',
  ...
  nameBadgesPickPdfPath: 'name-badges:pick-pdf-path',
